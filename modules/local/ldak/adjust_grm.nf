...
process ADJUST_GRM_LDAK {
  ...
  output:
  tuple val(phenotype_name), val("${grm_basename}_${phenotype_slug}_adj"), path("${grm_basename}_${phenotype_slug}_adj.grm.bin"), path("${grm_basename}_${phenotype_slug}_adj.grm.id"), path("${grm_basename}_${phenotype_slug}_adj.grm.details"), path("${grm_basename}_${phenotype_slug}_adj.grm.adjust"), path("${grm_basename}_${phenotype_slug}_adj.grm.root"), emit: adjusted_grm
  ...
  phenotype_slug = phenotype_name.replaceAll(/[^A-Za-z0-9._-]+/, '_')
  ...
  """
    ...
    ldak6 --adjust-grm ${grm_basename}_${phenotype_slug}_adj \\
